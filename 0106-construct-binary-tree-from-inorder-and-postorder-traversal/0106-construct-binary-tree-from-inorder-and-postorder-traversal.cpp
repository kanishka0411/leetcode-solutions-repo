...
public: 
    ...
    unordered_map<int,int>&inmap){
        ...
        root->left=build(postorder,poststart,poststart+numleft-1,inorder,instart,inroot-1,inmap);
        root->right=build(postorder,poststart+numleft,postend-1,inorder,inroot+1,inend,inmap);
        return root;
    }
